...
function configReactCore({indent, dangleRules}, env) {
    return {
        plugins: [
            'react',
        ],
        ...
        rules: {
            ...
            'react/jsx-boolean-value': [env === ENVS.DEVELOPMENT ? 'warn' : 'error', 'never', { always: [] }],
            ...
            // TODO: uncomment additional parameters when eslint-plugin-react v.8 will be supported:
            'react/jsx-key': ['error'/* , {
            ...
            'react/prop-types': [env === ENVS.DEVELOPMENT ? 'warn' : 'error', {
                ignore: [],
                customValidators: [],
            ...
            'react/no-unused-prop-types': [env === ENVS.DEVELOPMENT ? 'warn' : 'error', {
                customValidators: [
                ],
                skipShapeProps: true,
            }],
...
module.exports = configToPathString(configReactCore);